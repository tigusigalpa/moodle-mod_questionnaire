...
class questionnaire {
    ...
    public function delete_insert_response($rid, $sec, $quser) {
        ...
        $this->rid = $this->response_insert($this->survey->id, $sec, $rid, $quser);
        return $this->rid;
    }
    ...
    public function commit_submission_response($rid, $quser) {
        ...
        questionnaire_record_submission($this, $quser, $rid);
    ...
    */
    ...
    public function response_insert_bysec($rid, $section, $mobile = false) {
